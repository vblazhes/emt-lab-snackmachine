...
public class PurchaseCreatedEventTranslator implements RemoteEventTranslator {
    ...
    public boolean supports(StoredDomainEvent storedDomainEvent) {
        return storedDomainEvent.domainEventClassName().equals("mk.ukim.finki.emt.labs.dormitorysmartsnackmachine.snackmachine.domain.event.PurchaseForStudentCardCreated");
    }

    @Override
    public Optional<DomainEvent> translate(StoredDomainEvent remoteEvent) {
        var purchaseForSnackCreated = remoteEvent.toDomainEvent(objectMapper, PurchaseCreatedEvent.class);
        return Optional.of(new PurchaseCreatedEvent(purchaseForSnackCreated.getPurchaseId(), purchaseForSnackCreated.getOccurredOn(), purchaseForSnackCreated.getStudentCardId(), purchaseForSnackCreated.getAmount()));
    }
}
